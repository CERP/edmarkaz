...
class TabsBar extends Component<propTypes, S> {
  ...
  render() {
    ...
    const callLink = this.props.connected
      ? "https://api.whatsapp.com/send?phone=923481119119"
      : "tel:0348-1119-119";
        ...
        <div className="tabs-page">
          ...
          <>
            ...
            <TrackedRoute
              exact
              path="/library"
              component={LibraryInstructionMedium}
            />
            <TrackedRoute
              exact
              path="/library/:medium/:grade"
              component={StudentPortalOptions}
            />
            <TrackedRoute
              exact
              path="/library/:medium"
            ...
            <TrackedRoute
              exact
              path="/library/:medium/:grade/:subject"
              component={Library}
            />
            <TrackedRoute
              exact
              path="/library/:medium/:grade/:subject/:chapter/:chapter_name"
