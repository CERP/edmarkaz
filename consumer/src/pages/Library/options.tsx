...
const StudentPortalOptions: React.FC<Props> = ({
  getLessons,
  lessons,
  lesson_loading,
  match,
  ...
  return lesson_loading ? (
    ...
    <div className="student-portal-op">
      {lessons[medium] ? (
        ...
        <Container maxWidth="sm">
          <Typography
            ...
            gutterBottom
          >
            We couldn't find anything. Please write to us via{" "}
            <a href="tel:0348-1119-119">Sms</a>
            <br />
            or
            <a href="https://api.whatsapp.com/send?phone=923481119119">
              Whatsapp
            </a>
