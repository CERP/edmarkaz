...
const AppPrivacy = () => {
	return <div className="front about-us">
		<PublicHeader />
		<Typography variant="h4" align="center">Privacy Policy</Typography>
		<Container component="div">
			<p>
				CERP Labs built the MISchool Companion App app as a Free app. This SERVICE is provided by CERP Labs at no cost and is intended for use as is.
				This page is used to inform visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service.
				If you choose to use our Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that we collect is used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy.
				The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at MISchool Companion App unless otherwise defined in this Privacy Policy.
			</p>
			...
			<p>
				We want to inform you that whenever you use our Service, We don't collect any data.
			</p>
			...
			<p>
				...
				This policy is effective as of <strong>2019-01-12</strong>
			</p>
			<Typography variant="h5">Contact us</Typography>
			<p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at <a href="mailto:labs@cerp.org.pk">labs@cerp.org.pk</a>.</p>
		</Container>
	</div>
}
